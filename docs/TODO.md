...
`done: <file>`, `dropped: <reason>`; rows are never deleted. Previous backlog:
`research/plan/2026-08-18_cross_backlog.html`.
...
**This week (2026-09-02):** TODO 7 (pointdit choices), 8 (sum at 0.02 tc512), 9 (sky in the flow eval loss),
10 (FVD on OccAny features).

| # | Item | Thread | Paper | Status |
|---|---|---|---|---|
| 1 | Try 1, 2, 3, 4 steps like PointDiT | flow | ablation: ODE steps | `not started`. Context: eval-time step sweep in `research/analysis/2026-09-01_flow_numsteps_why_more_steps_degrade.md` |
