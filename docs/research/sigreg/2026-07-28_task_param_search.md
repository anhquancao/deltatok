...
- `lejepa/multivariate/slicing.py:104,146` has a `clip_value` knob we do not implement: it zeroes any
  ...
  `docs/research/sigreg/2026-07-25_analysis_sigreg_debug.md`. **Out of scope here** — it is a code change, not a parameter — but it is
...
`docs/research/sigreg/2026-07-25_analysis_sigreg_debug.md`. So this axis buys gradient reproducibility (which was `cos=0.08` between two
