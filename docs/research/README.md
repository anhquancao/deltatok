...
| 2026-09-02 | [cov_penalty](plan/2026-09-02_sigreg_cov_penalty.md) | plan, **read landed** | Does a direct `‖E[zzᵀ]−I‖²_F/Cz` penalty break the ~90/512 rank ceiling the weight axis cannot? | `BSC:45416718` ran to ep 72. Rank 101.8 → 120.2 (+18%) but the ≥150 bar failed; eval `LossRecon_Comp` −8.9% K / −8.5% N vs the twin. §4–5 filled |
