...
| Thread | Open |
|---|---|
| [`tc_width`](#tc_width--channel-and-token-budget-of-the-delta-token) | Answered 2026-09-07: `sigreg_weight` does not turn over at tc512 — 0.01–0.04 is one 6% plateau, 0.08 breaks, and the `∝ Cz` exponent stays unidentified (TODO 2 closed). New 2026-09-07: does a noisy channel the encoder must survive raise usable rank off the ~92–105/512 shelf, where the `cov_weight` axis raised rank without raising recon? [`plan/2026-09-07_tc_width_decnoise_e2e_tc512.md`](plan/2026-09-07_tc_width_decnoise_e2e_tc512.md), BSC:45529827 running. Interim ep-37 read 2026-09-08, **negative**: rank is *halved* (40.3 vs 78.7), because a fixed absolute σ is answered with a 1.91× larger `z` rather than more dimensions — [deck](results/2026-09-08_tc_width_decnoise_e2e_tc512_read_slides.html). |
