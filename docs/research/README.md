...
| 2026-09-04 | [decoder_noise_finetune](plan/2026-09-04_flow_decoder_noise_finetune.md) | plan, **read landed** | Does a decoder-only finetune on `z + σ·N(0,I)`, σ ~ U(0, 0.8), encoder frozen, lift the flow's 1-step decoded metrics with `MSEToken` unchanged? | No. Falsifier 2: the ladder flattens (σ=0.82 raymap 19.09 → 1.67) but flow N=1 raymap goes **+17.7%**. N=20 is **−35.5%**. §4 filled |
