...
Five cycles in one file, one per question: each Q runs hypothesis → results → findings in place. Q5 continues as its own task file, `2026-09-01_task_sigreg_weight_tc512.md`. New cycles start from `../TEMPLATE.md`.
...
- **The old read was an artifact.** `docs/research/compose/2026-08-25_report_compose_vs_plain_slides.html` previously called 0.0401 the "compose
...
Deck: `docs/research/compose/2026-08-25_report_compose_vs_plain_slides.html` (8 slides, rewritten 2026-08-27; slides 05–06 are the AR visuals).
...
Deck: `docs/research/tc_width/2026-08-27_report_tc_sigreg_ab_slides.html` (7 slides, 2026-08-27).
...
Deck: `docs/research/tc_width/2026-09-01_report_tc512_sigreg_weight_slides.html` (9 slides; 04–05 are the AR visuals).
...
- **Script:** `slurm/deltatok/train_deltatok_compose_sigregsum_nozn_tc512_bsc.slurm` (`ehpc880`, 72 h), design in
  `docs/research/sigreg/2026-08-27_impl_sigreg_compose_z.md`, code in `1140de1` (`training.sigreg_compose_z=true`, `deltatok_trainer.py:644,960,1057`).
...
Split into its own tracker: `docs/research/tc_width/2026-09-01_task_sigreg_weight_tc512.md`, which carries the full
...
Decks: `docs/research/compose/2026-08-25_report_compose_vs_plain_slides.html` (Q1), `docs/research/tc_width/2026-08-27_report_tc_sigreg_ab_slides.html` (Q2),
`docs/research/tc_width/2026-09-01_report_tc512_sigreg_weight_slides.html` (Q3/Q4).
