...
Created 2026-09-01. Splits Q5 out of `docs/task/bsc_compose_convergence_sigreg_tc_26-08-2026.md`, which answered
...
`docs/journal/deltatok_sigreg_pool_not_weight_neutral_2026-07-31.html`.
...
Prior decks: `docs/slide/deltatok_tc512_sigreg_weight_slides.html` (0.005 vs 0.01 vs sigregsum),
`docs/slide/deltatok_tc_sigreg_ab_slides.html` (0.002 vs 0.005).
