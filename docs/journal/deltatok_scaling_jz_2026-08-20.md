...
Tables and plot regenerate into `docs/journal/deltatok_scaling_jz.{csv,md,png,svg}`.
...
python parse_scaling_bench.py --logs <logdir> --out-stem docs/journal/deltatok_scaling_jz
```
