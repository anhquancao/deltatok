...
export EXP_NAME="occany_plus_recon_1B_scaled_DA3_depth_individual"
...
$CMD \
    ...
    --output_dir="/gpfs/scratch/ehpc558/quan/occrae_log/$EXP_NAME" \
    ...
    --aux_branch_layers 6 --aux_metric_pseudo_supervision \
     --lambda_depth 1.0 --lambda_pointmap 1.0 --sam3_use_dpt_proj

# Per-image frozen teacher pass (prefix + aux_blocks + aux_head) provides pseudo depth;
# multi-view student pass uses the same frozen prefix plus the trainable final blocks.
