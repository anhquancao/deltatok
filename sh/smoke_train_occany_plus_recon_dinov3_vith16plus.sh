#!/bin/bash
# Smoke test for the DINOv3 cross-view backbone memory footprint.
#
...
#   T=30 bash sh/smoke_train_occany_plus_recon_dinov3_vith16plus.sh
#   T=20 bash sh/smoke_train_occany_plus_recon_dinov3_vith16plus.sh
#   T=10 bash sh/smoke_train_occany_plus_recon_dinov3_vith16plus.sh
#
...
export EXP_NAME="smoke_occany_plus_recon_dinov3_vith16plus_T${T}"
