...
def main():
    ...
    for idx, sequence_name in enumerate(sequence_list):
        ...
        # Select frames: idx 9 11 13 15
        start_idx = 9  # 0-based index for the 14th frame
        step = 2
        sequence_length = 4
        ...
        # FM: generate depth for the last two frames
        ...
        pred_depth = depth[0, 2, :, :, 0].detach().clone()  # third frame (0-based)
