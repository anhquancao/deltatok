...
class LPIPS(nn.Module):
    ...
    def __init__(self, use_dropout: bool = True, ckpt_root: str | None = None) -> None:
        super().__init__()
        ...
        self._load_pretrained_weights(root=ckpt_root)
        for param in self.parameters():
            param.requires_grad = False

    def _load_pretrained_weights(self, name: str = "vgg_lpips", root: str | None = None) -> None:
        ckpt = get_ckpt_path(name, root=root)
