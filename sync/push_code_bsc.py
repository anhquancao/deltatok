#!/usr/bin/env python3
"""Watch the repo for changes and rsync to BSC on each event."""
...
def main():
    parser = argparse.ArgumentParser(description="Watch repo and rsync to BSC.")
    parser.add_argument("-n", "--dry-run", action="store_true")
    parser.add_argument("--remote", default="bsc")
    parser.add_argument("--remote-dir", default="/home/vale/vale352205/code")
