...
| KITTI 5frames | OccAny+ recon 1.1B (lidar-scaled depth sup.) | 1.07 | 1.26 | 1.17 | 58.60 | 78.37 | 66.67 |
...
| nuScenes surround | OccAny+ recon 1.1B (lidar-scaled depth sup.) | 3.37 | 1.03 | 2.20 | 36.15 | 57.85 | 44.10 |
...
| KITTI 5frames | OccAny+ recon 1.1B (lidar-scaled depth) | 10.25 | 0.66 | 4.29 | 0.20 | 89.57 | 95.95 | 98.00 |
...
| nuScenes surround | OccAny+ recon 1.1B (lidar-scaled depth) | 29.63 | 3.78 | 7.42 | 0.37 | 62.64 | 85.31 | 93.47 |
...
# EXP_ID=4: KITTI OccAny+ 1B lidar-supervised, EXP_ID=5: nuScenes OccAny+ 1B lidar-supervised
...
| `4` | `occany_da3` | KITTI | 5frames | `occany_plus_recon_1B_sup_lidar_scaled_da3.pth` |
| `5` | `occany_da3` | nuScenes | surround | `occany_plus_recon_1B_sup_lidar_scaled_da3.pth` |
